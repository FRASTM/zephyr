...
/*
 * DAC output on PA4 (D7)
 * ADC input read from PC3 (A2)
 */
#define DAC_DEVICE_NODE		DT_NODELABEL(dac1)
#define DAC_CHANNEL_ID		1
#define DAC_RESOLUTION		12
...
/*
 * DAC output on PA4 (A1)
 * ADC input read from PF12 (A5)
 */
#define DAC_DEVICE_NODE		DT_NODELABEL(dac1)
#define DAC_CHANNEL_ID		1
#define DAC_RESOLUTION		12
...
/*
 * DAC output on PA4 (D24)
 * ADC input read from PA3 (A0)
 */
#define DAC_DEVICE_NODE		DT_NODELABEL(dac1)
#define DAC_CHANNEL_ID		1
#define DAC_RESOLUTION		12
