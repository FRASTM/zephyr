...
/** STM2H7RS specifics RCC dividers */
#if defined(CONFIG_SOC_SERIES_STM32H7RSX)
#define STM32_D1CPRE	DT_PROP(DT_NODELABEL(rcc), dcpre)
#define STM32_HPRE	DT_PROP(DT_NODELABEL(rcc), hpre)
#define STM32_D1PPRE	DT_PROP(DT_NODELABEL(rcc), ppre1)
#define STM32_D2PPRE	DT_PROP(DT_NODELABEL(rcc), ppre2)
#define STM32_D4PPRE	DT_PROP(DT_NODELABEL(rcc), ppre4)
#define STM32_D5PPRE	DT_PROP(DT_NODELABEL(rcc), ppre5)
#else
