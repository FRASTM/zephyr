...
#define FLASH_STM32_NSBKER_MSK FLASH_CR_BER_Msk
#define FLASH_STM32_NSBKER FLASH_CR_BER
#define FLASH_STM32_NSPER FLASH_CR_BER
#define FLASH_STM32_NSPNB_MSK FLASH_CR_SNB_Msk
#define FLASH_STM32_NSPNB_POS FLASH_CR_SNB_Pos
#define FLASH_STM32_NSPNB FLASH_CR_SNB
#define FLASH_STM32_NSSTRT FLASH_CR_START
#define FLASH_PAGE_SIZE_128_BITS FLASH_SECTOR_SIZE
