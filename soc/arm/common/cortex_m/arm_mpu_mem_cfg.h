...
#ifdef CONFIG_XIP
/* External Mmeory Region Definitions */
#if CONFIG_EXTMEM_SIZE <= 64
#define REGION_EXTMEM_SIZE REGION_64K
#elif CONFIG_EXTMEM_SIZE <= 128
#define REGION_EXTMEM_SIZE REGION_128K
#elif CONFIG_EXTMEM_SIZE <= 256
#define REGION_EXTMEM_SIZE REGION_256K
#elif CONFIG_EXTMEM_SIZE <= 512
#define REGION_EXTMEM_SIZE REGION_512K
#elif CONFIG_EXTMEM_SIZE <= 1024
#define REGION_EXTMEM_SIZE REGION_1M
#elif CONFIG_EXTMEM_SIZE <= 2048
#define REGION_EXTMEM_SIZE REGION_2M
#elif CONFIG_EXTMEM_SIZE <= 4096
#define REGION_EXTMEM_SIZE REGION_4M
#elif CONFIG_EXTMEM_SIZE <= 8192
#define REGION_EXTMEM_SIZE REGION_8M
#elif CONFIG_EXTMEM_SIZE <= 16384
#define REGION_EXTMEM_SIZE REGION_16M
#elif CONFIG_EXTMEM_SIZE <= 65536
#define REGION_EXTMEM_SIZE REGION_64M
#elif CONFIG_EXTMEM_SIZE <= 131072
#define REGION_EXTMEM_SIZE REGION_128M
#elif CONFIG_EXTMEM_SIZE <= 262144
#define REGION_EXTMEM_SIZE REGION_256M
#elif CONFIG_EXTMEM_SIZE <= 524288
#define REGION_EXTMEM_SIZE REGION_512M
#else
#error "Unsupported external memory size configuration"
#endif
#endif /* CONFIG_XIP */
